  ...
  return (
    <div className="apoio-form">
      <div className="apoio-form__fields">
        ...
        <div className="apoio-form__field">
          <label className="apoio-form__label">Repetir</label>
          <SearchableSelect
            id="recurrence-apoio"
            value={recurrence}
        ...
        {recurrence !== 'nunca' && (
          <div className="apoio-form__recurrence-options">
            <div className="apoio-form__field">
              <label className="apoio-form__label">Termina</label>
              <SearchableSelect
                id="end-type-apoio"
                value={endType}
            ...
            {endType === 'date' && (
              <div className="apoio-form__field">
                <label className="apoio-form__label">Data limite</label>
                <input
                  type="date"
                  className="apoio-form__input"
            ...
            {endType === 'count' && (
              <div className="apoio-form__field">
                <label className="apoio-form__label">Número de repetições</label>
                <input
                  type="number"
                  className="apoio-form__input"
                  min="1"
            ...
            <label className="apoio-form__checkbox-label">
              <input
                type="checkbox"
