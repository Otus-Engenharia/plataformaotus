...
function TecnologiaForm({ selectedDate, onSubmit, submitting }) {
  ...
  const handleSubmit = () => {
    ...
    if (!taskName) {
      ...
      taskName = grupo ? grupo.label : 'Tecnologia';
    }
  ...
  if (loadingData) {
    return (
      <div className="tec-form__loading">
        <div className="tec-form__loading-spinner" />
        Carregando dados...
      </div>
    );
  }
  ...
  return (
    <div className="tec-form">
      <div className="tec-form__fields">
        <div className="tec-form__field">
          <label className="tec-form__label">Grupo de atividades padrão</label>
          <SearchableSelect
            id="grupo-atividade-tec"
        ...
        <div className="tec-form__field">
          <label className="tec-form__label">
            Nome da Tarefa <span className="tec-form__optional">(opcional)</span>
          </label>
          <input
            type="text"
            ...
            placeholder="Ex: Implementação BIM"
          />
        </div>

        <div className="tec-form__field">
          <div className="tec-form__project-header">
            <label className="tec-form__label">Projetos</label>
            <div className="tec-form__project-actions">
              {showFavorites && favoriteProjects.length > 0 && (
                <button
                  type="button"
                  className="tec-form__select-all-btn"
                  onClick={() => {
              ...
              <div className="tec-form__toggle">
                <button
                  type="button"
                  className={`tec-form__toggle-btn${showFavorites ? ' is-active' : ''}`}
        ...
        <div className="tec-form__dates">
          <div className="tec-form__field tec-form__field--half">
            <label className="tec-form__label">Data de início</label>
            <div className="tec-form__readonly">
              <span className="tec-form__readonly-date">{startDateLabel}</span>
              <span className="tec-form__readonly-time">{startTimeLabel}</span>
            </div>
          </div>

          <div className="tec-form__field tec-form__field--half">
            <label className="tec-form__label">Término</label>
            <SearchableSelect
              id="hora-termino-tec"
              value={horaTermino}
        ...
        <button
          type="button"
          className="tec-form__submit-btn"
