...
function CoordenacaoForm({ selectedDate, onSubmit, submitting }) {
  ...
  // Limpar projetos selecionados que não existem na lista atual ao trocar o toggle
  ...
  if (loadingData) {
    return (
      <div className="coordenacao-form__loading">
        <div className="coordenacao-form__loading-spinner" />
        Carregando dados...
      </div>
    );
  }
  ...
  return (
    <div className="coordenacao-form">
      <div className="coordenacao-form__fields">
        <div className="coordenacao-form__field">
          <label className="coordenacao-form__label">Grupo de atividades padrão</label>
          <SearchableSelect
            id="grupo-atividade"
        ...
        <div className="coordenacao-form__field">
          <label className="coordenacao-form__label">
            Nome da Tarefa <span className="coordenacao-form__optional">(opcional)</span>
          </label>
          <input
            type="text"
            className="coordenacao-form__input"
            value={nomeTarefa}
        ...
        <div className="coordenacao-form__field">
          <div className="coordenacao-form__project-header">
            <label className="coordenacao-form__label">Projetos</label>
            <div className="coordenacao-form__project-actions">
              {showFavorites && favoriteProjects.length > 0 && (
                <button
                  type="button"
                  className="coordenacao-form__select-all-btn"
                  onClick={() => {
              ...
              <div className="coordenacao-form__toggle">
                <button
                  type="button"
                  className={`coordenacao-form__toggle-btn${showFavorites ? ' is-active' : ''}`}
        ...
        <div className="coordenacao-form__dates">
          <div className="coordenacao-form__field coordenacao-form__field--half">
            <label className="coordenacao-form__label">Data de início</label>
            <div className="coordenacao-form__readonly">
              <span className="coordenacao-form__readonly-date">{startDateLabel}</span>
              <span className="coordenacao-form__readonly-time">{startTimeLabel}</span>
            </div>
          </div>

          <div className="coordenacao-form__field coordenacao-form__field--half">
            <label className="coordenacao-form__label">Término</label>
            <SearchableSelect
              id="hora-termino"
              value={horaTermino}
        ...
        <div className="coordenacao-form__field">
          <label className="coordenacao-form__label">Repetir</label>
          <SearchableSelect
            id="recurrence-coordenacao"
            value={recurrence}
        ...
        {recurrence !== 'nunca' && (
          <div className="coordenacao-form__recurrence-options">
            <div className="coordenacao-form__field">
              <label className="coordenacao-form__label">Termina</label>
              <SearchableSelect
                id="end-type-coordenacao"
                value={endType}
            ...
            {endType === 'date' && (
              <div className="coordenacao-form__field">
                <label className="coordenacao-form__label">Data limite</label>
                <input
                  type="date"
                  className="coordenacao-form__input"
            ...
            {endType === 'count' && (
              <div className="coordenacao-form__field">
                <label className="coordenacao-form__label">Número de repetições</label>
                <input
                  type="number"
                  className="coordenacao-form__input"
                  min="1"
            ...
            <label className="coordenacao-form__checkbox-label">
              <input
                type="checkbox"
        ...
        <button
          type="button"
          className="coordenacao-form__submit-btn"
...
export default CoordenacaoForm;
