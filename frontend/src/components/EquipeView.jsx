...
function EquipeView({ selectedProjectId }) {
    ...
    try {
      if (editingItem) {
        ...
        await axios.post(`${API_URL}/api/projetos/equipe`, {
          ...formData,
          construflow_id: selectedProjectId
        }, {
          withCredentials: true
        });
      }
                ...
                <tr>
                  <td colSpan="8" className="equipe-empty-row">
                    <div className="equipe-empty-row-content">
                      ...
                      <span>Nenhuma equipe cadastrada para este projeto</span>
                    </div>
                  </td>
                </tr>
              ) : (
                ...
                {editingItem ? (
                  ...
                  <>
                    <select
                      ...
                      onChange={(e) => {
                        // Limpa o contato e campos relacionados quando a empresa muda
                        setFormData({
                          ...formData,
